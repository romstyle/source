...
class boss_amazarkul : public CreatureScript
{
public:
	boss_amazarkul() : CreatureScript("boss_amazarkul") { }

    CreatureAI* GetAI(Creature* creature) const OVERRIDE
    {
		return new boss_amazarkulAI(creature);
    }
	struct boss_amazarkulAI : public BossAI
	{
		boss_amazarkulAI(Creature* creature) : BossAI(creature, 0)
        {
